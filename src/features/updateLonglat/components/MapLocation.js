          ...
          <Marker key="old-latest" position={pos} icon={redIcon} opacity={0.7}>
            <Popup>
              <div className="flex flex-col gap-1 text-xs m-0">
                {/* Teks hitam khusus untuk popup agar selalu terbaca jika background popup terang */}
                <strong className="text-slate-900 dark:text-slate-100 leading-none">
                  {t('longlat.modal.old_loc')}
                </strong>
                <span className="font-mono text-slate-800 dark:text-slate-300 leading-none">
      ...
      elements.push(
        ...
        >
          <Popup>
            <div className="flex flex-col gap-1 text-xs m-0">
              <strong className="text-slate-900 dark:text-slate-100 leading-none">
                {t('longlat.modal.new_loc')}
              </strong>
              <span className="font-mono text-slate-800 dark:text-slate-300 leading-none">
                {formatToSix(item.newLonglat)}
              </span>
              <span className="leading-none mt-0.5 text-slate-700 dark:text-slate-400">
