export const tutorialData = (t) => ({
  routing: [
    {
      image: '/images/tutorial/routing/routing-1.png',
      text: t('report.manual_input.routing_guide.step_1'),
    },
    {
      image: '/images/tutorial/routing/routing-2.png',
      text: t('report.manual_input.routing_guide.step_2'),
    },
    {
      image: '/images/tutorial/routing/routing-3.png',
      text: t('report.manual_input.routing_guide.step_3'),
    },
    {
  ...
  delivery: [
    ...
    },
    {
      ...
      text: t('report.manual_input.delivery_guide.step_2'),
    },
    {
      image: '/images/tutorial/task/task-3.png',
      text: t('report.manual_input.delivery_guide.step_3'),
    },
    {
      image: '/images/tutorial/task/task-4.png',
      text: t('report.manual_input.delivery_guide.step_4'),
    },
    {
      image: '/images/tutorial/task/task-5.png',
      text: t('report.manual_input.delivery_guide.step_5'),
    },
  ],
});
